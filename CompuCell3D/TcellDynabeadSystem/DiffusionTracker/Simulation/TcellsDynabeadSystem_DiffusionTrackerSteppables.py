...
class TrajectoryTrackerSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        self.trajectory_writer = XTCWriter(
            r"C:\Users\norac\OneDrive - UAB\Escritorio\uab\5\TFGJordi\ExperimentalData\TcellsDynabeadSystem\TcellsDynabeadSystem_DiffusionTracker\cell_trajectories.xtc", self.num_atoms)
        ...
        with PDBWriter(r"C:\Users\norac\OneDrive - UAB\Escritorio\uab\5\TFGJordi\ExperimentalData\TcellsDynabeadSystem\TcellsDynabeadSystem_DiffusionTracker\frame0.pdb") as pdb_writer:
