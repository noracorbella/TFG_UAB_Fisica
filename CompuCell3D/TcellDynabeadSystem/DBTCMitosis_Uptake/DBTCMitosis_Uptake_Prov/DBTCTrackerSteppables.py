...
class TrajectoryTrackerSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        with PDBWriter(r"C:\Users\norac\OneDrive - UAB\Escritorio\uab\5\TFGJordi\ExperimentalData\TcellsDynabeadSystem\DBTCMitosis_Uptake\DBTCMitosis_Uptake_4\DBTC_frame0.pdb") as pdb_writer:
            pdb_writer.write(self.universe.atoms)

        self.trajectory_writer = XTCWriter(r"C:\Users\norac\OneDrive - UAB\Escritorio\uab\5\TFGJordi\ExperimentalData\TcellsDynabeadSystem\DBTCMitosis_Uptake\DBTCMitosis_Uptake_4\DBTC_traj.xtc", self.num_atoms)
...
class NutrientFieldSteppable(SteppableBasePy):
    def __init__(self, frequency=1):
        ...
        self.nutrient_replenishment_rate = 0.0  # Add nutrient replenishment
    ...
    def start(self):
        ...
        self.nutrient_uptake_file = open(r"C:\Users\norac\OneDrive - UAB\Escritorio\uab\5\TFGJordi\ExperimentalData\TcellsDynabeadSystem\DBTCMitosis_Uptake\DBTCMitosis_Uptake_4\nutrient_uptake_data.txt", "w")
...
class TCellMitosisSteppable(MitosisSteppableBase):
    def __init__(self,frequency=1):
        ...
        self.nutrient_division_threshold = 0.04  # Minimum recent nutrient consumption for division
        self.max_divisions = 5

    def start(self):
        self.TC_count_file = open(r"C:\Users\norac\OneDrive - UAB\Escritorio\uab\5\TFGJordi\ExperimentalData\TcellsDynabeadSystem\DBTCMitosis_Uptake\DBTCMitosis_Uptake_4\TC_count.txt", "w")
...
class EnergyTrackerSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        self.output_file = open(r"C:\Users\norac\OneDrive - UAB\Escritorio\uab\5\TFGJordi\ExperimentalData\TcellsDynabeadSystem\DBTCMitosis_Uptake\DBTCMitosis_Uptake_4\energy_file.txt", "w")
        ...
        self.data_file = open(r"C:\Users\norac\OneDrive - UAB\Escritorio\uab\5\TFGJordi\ExperimentalData\TcellsDynabeadSystem\DBTCMitosis_Uptake\DBTCMitosis_Uptake_4\cell_data.txt", "w")
