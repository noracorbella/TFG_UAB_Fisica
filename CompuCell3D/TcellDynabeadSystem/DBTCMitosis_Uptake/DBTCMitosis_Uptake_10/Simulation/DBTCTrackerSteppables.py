...
class TrajectoryTrackerSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        with PDBWriter(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_10/DBTC_frame0.pdb") as pdb_writer:
            pdb_writer.write(self.universe.atoms)

        self.trajectory_writer = XTCWriter(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_10/DBTC_traj.xtc", self.num_atoms)
...
class NutrientFieldSteppable(SteppableBasePy):
    def __init__(self, frequency=1):
        ...
        self.base_uptake_rate = 0.01  # Base uptake rate for regular T cells
        self.activated_uptake_multiplier = 1.0  # Activated T cells consume more nutrients

        self.max_nutrient_concentration = 4.0  # Maximum nutrient concentration
    ...
    def start(self):
        ...
        self.nutrient_uptake_file = open(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_10/nutrient_uptake_data.txt", "w")
...
class TCellMitosisSteppable(MitosisSteppableBase):
    ...
    def start(self):
        self.TC_count_file = open(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_10/TC_count.txt", "w")
...
class EnergyTrackerSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        self.output_file = open(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_10/energy_file.txt", "w")
        ...
        self.data_file = open(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_10/cell_data.txt", "w")
