...
class TrajectoryTrackerSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        with PDBWriter(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_22/DBTC_frame0.pdb") as pdb_writer:
            pdb_writer.write(self.universe.atoms)

        self.trajectory_writer = XTCWriter(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_22/DBTC_traj.xtc", self.num_atoms)
...
class NutrientFieldSteppable(SteppableBasePy):
    def __init__(self, frequency=1):
        ...
        self.base_uptake_rate = 0.11  # Base uptake rate for regular T cells
        self.activated_uptake_multiplier = 4  # Activated T cells consume more nutrients
        self.nutrient_replenishment_rate = 0.055  # Add nutrient replenishment
    ...
    def start(self):
        ...
        self.nutrient_uptake_file = open(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_22/nutrient_uptake_data.txt", "w")
...
class TcellGrowthSteppable(MitosisSteppableBase):
    def __init__(self, frequency = 1):
        ...
        self.base_growth_rate = 0.0125  # Base growth rate (pixels/MCS) - slower than original
        self.max_growth_rate = 0.025  # Maximum growth rate with optimal nutrients
        
        
        self.activated_growth_multiplier = 1  # Activated cells grow 50% faster
...
class TCellMitosisSteppable(MitosisSteppableBase):
    def __init__(self,frequency=1):
        ...
        self.nutrient_division_threshold = 0.02 # Minimum recent nutrient consumption for division
        self.max_divisions = 10

    def start(self):
        self.TC_count_file = open(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_22/TC_count.txt", "w")
...
class EnergyTrackerSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        self.output_file = open(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_22/energy_file.txt", "w")
        ...
        self.data_file = open(r"/Users/nora/Desktop/TFGJordi/DBTCMitosis_Uptake_22/cell_data.txt", "w")
